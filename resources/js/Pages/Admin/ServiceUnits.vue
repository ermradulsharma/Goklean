    ...
    <app-layout title="Service Units">
        ...
        <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <vue-good-table mode="remote" v-on:page-change="onPageChange" v-on:column-filter="onColumnFilter" v-on:per-page-change="onPerPageChange"
                            ...
                            :totalRows="serviceUnits.meta.pagination.total"
                            :rows="serviceUnits.data" :rtl="$page.props.rtl">
                <template #table-row="props">
                    ...
                    <div v-else-if="props.column.field === 'actions'">
                        ...
                        <Button icon="pi pi-trash" class="p-button-rounded p-button-danger p-button-text"
                                @click="deleteServiceUnit(props.row.id)"/>
                    </div>
            ...
            <Sidebar position="right" v-model:visible="createForm" class="p-sidebar-md">
                <ServiceUnitForm :form-errors="errors" :cities="cities"
                              @close="createForm = false;" :title="'New ServiceUnit'"/>
            </Sidebar>
            <Sidebar position="right" v-model:visible="editForm" class="p-sidebar-md">
                <ServiceUnitForm :form-errors="errors" :cities="cities"
                              :edit-flag="editForm" @close="editForm = false;" :service-unit-id="currentId" :title="'Edit Service Unit'"/>
            </Sidebar>
        </div>
    </app-layout>
</template>
