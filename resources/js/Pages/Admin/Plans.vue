<template>
    <app-layout title="Plans">
        <template #header>
            <h4 class="page-heading">Plans</h4>
        </template>
        <template #actions>
        ...
        <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <Sidebar position="right" v-model:visible="createForm" class="p-sidebar-md">
                <PlanForm :form-errors="errors" @close="createForm = false;" :title="'New Plan'"/>
            </Sidebar>
            <Sidebar position="right" v-model:visible="editForm" class="p-sidebar-md">
                <PlanForm :form-errors="errors" :edit-flag="editForm" @close="editForm = false;"
                         :plan-id="currentId" :title="'Edit Plan'"/>
            </Sidebar>
        </div>
    </app-layout>
</template>
