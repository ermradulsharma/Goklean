    ...
    <div class="overflow-y-auto h-screen px-2">
        ...
        <form v-else class="my-6 w-11/12 mx-auto xl:w-full xl:mx-0" @submit.prevent="submitForm">
            ...
            <div class="w-full flex flex-col mb-6">
                <label for="first_name" class="pb-2 font-semibold text-gray-800">Fist Name <span class="ml-1 text-red-400">*</span></label>
                <InputText type="text"
                           id="first_name"
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            create() {
                ...
                this.$inertia.post(route('admins.store'), this.form, {
                    onSuccess: () => {
            ...
            update() {
                this.formValidated = true;
                this.$inertia.patch(route('admins.update', { id: this.adminId }), this.form, {
                    onSuccess: () => {
                        if (Object.keys(this.errors).length === 0) {
                            this.$emit('close', true);
                        }
            ...
            fetch() {
                if(this.editFlag) {
                    let _this = this;
                    _this.loading = true;
                    axios.get(route('admins.edit', { id: this.adminId }))
