<template>
    <app-layout title="Invoices">
        ...
        <template #actions>
            ...
            <Button @click="createForm = true" class="p-button-success mx-5 invoice-btn" :label="'New Invoice'" />
            <Link :href="route('invoices.deleted.list')" class="p-button p-button-danger">Deleted Invoice</Link>
        </template>
            ...
            <vue-good-table mode="remote" v-on:page-change="onPageChange" v-on:column-filter="onColumnFilter" v-on:per-page-change="onPerPageChange" :pagination-options="options" :columns="columns" :totalRows="invoices.meta.pagination.total" :rows="invoices.data" :rtl="$page.props.rtl">
                <template #table-row="props">
                    ...
                    <div v-if="props.column.field === 'invoice_id'">
                        <Tag v-clipboard:copy="props.row.invoice_id" v-clipboard:success="handleCopyStatus" :value="props.row.invoice_id" icon="pi pi-copy"
                    ...
                    <div v-else-if="props.column.field === 'actions'">
                        <actions-dropdown>
                            <template #actions>
                                ...
                                <Link :href="route('invoices.edit', {id: props.row.id})" class="action-item">Edit</Link>
